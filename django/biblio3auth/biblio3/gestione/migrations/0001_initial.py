# Generated by Django 4.0.4 on 2022-04-15 08:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('utente', models.OneToOneField(default=None, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='copie_in_prestito', to=settings.AUTH_USER_MODEL)),
            ],
            options={
