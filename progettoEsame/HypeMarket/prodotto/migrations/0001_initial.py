    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offertaMaggiore', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='taglie', to='gestione.offerta')),
                ('prodotto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='taglie', to='prodotto.prodotto')),
                ('propostaMinore', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='taglie', to='gestione.proposta')),
            ],
        ),
    ]
